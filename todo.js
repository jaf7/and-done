/*
N.B. Naming variables:
In the structure of this code I need to repeatedly access list items, and it
seems it would be more confusing to try to use unique names. The solution may be
to refactor this using Object Oriented design, where a list item
becomes a Constructor and interface similar to TextCell in Chapter 6 of
Eloquent Javasript.
*/
...
( function pageLoad( $ ) {
  $( document ).ready(function() {
    ...
    /*
      ...
      Object.keys returns an empty array, not 'undefined'. So I shouldn't
      need the left side of the following && operations (?).
    */
    if ( itemCounter ) {
    ...
    function addItemListeners( listItem ) {
      ...
      // preserve collapsed / expanded states across page loads (materialize adds/removes class="active")
